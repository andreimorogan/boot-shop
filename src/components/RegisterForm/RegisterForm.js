    ...
    return (
        <div className="container mt-5">
            <main className="form-signin w-100 m-auto">
                <form>
                    <Link to="/boot-shop"><img className="mb-4" id="c-signin-logo" src={Logo} alt="The demo logo" width="72" height="57" /></Link>
                    ...
                    <Link to="/boot-shop/register"><button className="w-100 btn btn-lg btn-info mt-3" type="submit">Sign up</button></Link>
                    <Link to="/boot-shop/signin"><button className="w-100 btn btn-lg btn-primary mt-3" type="submit">Back to sign in</button></Link>
                </form>
            </main>
        </div>
    );
